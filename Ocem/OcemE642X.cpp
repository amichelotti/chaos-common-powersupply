...
std::string OcemE642X::getSWVersion(uint32_t timeo_ms){
    char stringa[1024];
    int ret;
...
std::string OcemE642X::getHWVersion(uint32_t timeo_ms){
...
uint64_t OcemE642X::getAlarmDesc(){
  return POWER_SUPPLY_EVENT_DOOR_OPEN;
}			
